    ...
    <section>
      <footer className='footer-3-1 h-full py-24 lg:px-32 md:px-16 sm:px-8 px-4'>
        <div className='flex lg:flex-row flex-col mb-20'>
          <div className='lg:w-1/2 w-full lg:mb-0 mb-10'>
            ...
            <h5 className='text-sm leading-6 mt-5'>
              ...
              vitae nunc phasellus.
              <br /> Dui duis tortor, mattis phasellus ullamcorper etiam leo.{' '}
            </h5>
          </div>
          <div className='lg:w-1/2 w-full'>
            <div className='grid lg:grid-cols-3 lg:gap-0 gap-6'>
              <div>
                <h5 className='title-font font-semibold text-xl mb-5'>Plans</h5>
                <nav className='list-none text-green-800 transition duration-200 space-y-3'>
                  <li className='leading-8'>
                    <a href='#'>Student Solution</a>
                  </li>
                  <li className='leading-8'>
                    <a href='#'>Teacher Solution</a>
                  </li>
                  <li className='leading-8'>
                    <a href='#'>Pricing</a>
                  </li>
                  <li className='leading-8'>
                    <a href='#'>Working NeoClass</a>
                  </li>
                </nav>
              </div>
              <div>
                <h5 className='title-font font-semibold text-xl mb-5'>
                  About Us
                </h5>
                <nav className='list-none text-green-800 transition duration-200 space-y-3'>
                  <li className='leading-8'>
        ...
        <div className='mx-auto'>
          <div className='container mx-auto flex flex-col-reverse lg:flex-row justify-between items-center space-y-5 lg:space-y-0'>
            <nav className='text-base lg:text-left text-center lg:mt-0 mt-12'>
              <p>© 2021 with ABCD Project. All rights reserved.</p>
            </nav>
            <div className='flex footer-icon font-medium items-center text-gray-900 mb-4 lg:mb-0 md:mb-0 space-x-6'>
              <a href=''>
                <svg
                  className='cursor-pointer icon-fill'
                  width='20'
                  height='20'
                  viewBox='0 0 20 20'
                  fill='none'
              ...
              <a href=''>
                <svg
                  ...
                  xmlns='http://www.w3.org/2000/svg'
                >
                  <g clipPath='url(#clip0-footer-3-1)'>
                    <path
